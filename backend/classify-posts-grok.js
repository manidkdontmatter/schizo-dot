...
export async function classifyPostsGrok(posts) {
  ...
  for (let i = 0; i < chunks.length; i++) {
    ...
    try {
      ...
      console.log(`Grok response for chunk ${i + 1}: ${response}`);
